...
public class CWH_94_Hashing_Technique {
...
*suppose the example is having two same remainder values for same index then , if you can see that the 22 and 44 are mapped
 to the index number 2. Therefore we need to avoid the collision. Following techniques are used to avoid collision in hashing :
