...
class MyLiabrary {
    // ArrayList for storing the books
    ArrayList<Book> books;

    //com.company.Constructor
    public MyLiabrary(ArrayList<Book> books) {
        this.books = books;
    }
    ...
    public class CWH_113_Sol_EX_7 {
        public static void main(String[] args) {
            ...
            MyLiabrary l = new MyLiabrary(bk);
